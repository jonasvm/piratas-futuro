...
if(isset($_GET["chal"]))
{
	...
	$deleteChal2 = mysqli_query ($con, "DELETE FROM armas_brancas WHERE name = '$rowName[0]'") or die(mysqli_error($con));
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
		function Deletar(name, id)
		{
			if (confirm("Deseja deletar \n" + name + " ?")) {
				window.location = 'index_store.php?chal=' + id;
			}
		}
		</script>
	...
	<body>
		<div id="main">
			...
			<div id="content">
				...
				$html .= '<li class="selected"><a href="index_store.php">Armas Brancas</a></li>';
				...
				$html .= '<td><b>Informa&ccedil;&otilde;es</b></td><td><b>N&iacute;vel</b></td><td><b>Pre&ccedil;o</b></td><td width="40"><b>Editar</b></td><td width="40"><b>Excluir</b></td></tr>';
				$sql = mysqli_query($con, "SELECT level_required,name,description,id,buy_value,slot,sale_value FROM item WHERE type='2' ORDER BY level_required ") or die(mysqli_error($con));
				...
				while ($row2 = mysqli_fetch_assoc($sql)) {
					...
					$html .= '<center>Venda: ' . $row2['sale_value'] . ' moedas pirata <br /></td><td><a href="db_edit_item.php?item_id=' . $row2['id'] . '&item_type=2">';
					$html .= '<img src="images/edit icon.png" width="30" height="30" title="Editar"/></a></td><td><a href="#"><img src="images/delete icon.png" width="30" height="30" title="Excluir" onclick="Deletar(\''.utf8_encode($row2['name']).'\', '.$row2['id'].')"/></a></td></tr>';
