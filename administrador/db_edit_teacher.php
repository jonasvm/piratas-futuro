			...
			function valida(){
				...
				for(var i in array_name){
					if(nome == array_name[i]){
						alert("Nome escolhido já está sendo utilizado.");
						return false;
					}
				}
				...
				for(var i in array_email){
					if(email == array_email[i]){
						alert("Email inserido já está sendo utilizado por outro usuário");
						return false;
					}
				}
				if(!isEmail(email)){
				...
				if(idade > 80){
					alert("Você deve preencher o campo idade apenas com números válidos.");
					return false;
				}
				...
				for(var i in array_cpf){
					if(cpf == array_cpf[i]){
						alert("CPF inserido já está sendo utilizado por outro usuário");
						return false;
					}
				}
		...
		<div id="main">
			...
			<div id="top_menu">
					<ul id="top_menu">
						...
						<li><a href="about.php"><?php echo utf8_encode("Créditos") ?></a></li>
