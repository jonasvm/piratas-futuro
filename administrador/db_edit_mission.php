...
$sql1 = mysqli_query($con, "SELECT * FROM mission WHERE id <> '$mission_id'") or die(mysqli_error($con));
$i = 0;
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="style/style.css" />
			...
			function validate(){
				...
				if(money == ""){
					alert("Você deve preencher o campo Dinheiro.");
					return false;
				}
			}
		</script>
	...
	<body>
		<div id="main">
			...
			<div id="content">
				<h2 class="title">Editar Miss&atilde;o</h2>
