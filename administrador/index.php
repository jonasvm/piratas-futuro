	...
	<body>
		<div id="main">
			...
			<div id="content">
				...
				<input type="button" class="button" value="Cadastrar Desafio" id="botao" onclick="location.href='db_rg_challenge.php';">
				<?php
				include "conecta_mysql.inc";
				$sql2 = mysqli_query($con, "SELECT id, level,title FROM challenge ORDER BY level");
				...
				<form>
					...
					while($row = mysqli_fetch_array($sql2)) {
						...
						$html .= '<a href="db_detail_challenge.php?mission_id=' . $row[0] . '">' . $row[1] . '</a></td><td><a href="db_detail_challenge.php?mission_id=' . $row[0] . '">' . utf8_encode($row[2]) . '</a></td><td><a href="db_edit_challenge.php?mission_id=' . $row[0] . '"><img src="images/edit icon.png" width="30" height="30" title="Editar"/></a></td><td><a href="#"><img src="images/delete icon.png" width="30" height="30" title="Excluir" onclick="Deletar(\''.utf8_encode($row[2]).'\', '.$row[0].')"/></a></td></tr>';
