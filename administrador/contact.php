...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="main">
			...
			<div id="content">
				<div id="text">
					<h1 style="font-size:20px">Fale conosco!</h1>
					<p>Envie-nos um e-mail caso tenha dúvidas, sugestões ou queira reportar algum erro.</p>
					<p>E-mail: lucas.riboli14@gmail.com</p>
				</div>
				<br>
			</div>
		</div>
