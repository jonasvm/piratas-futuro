			...
			<div id="content">
				<div id="text">
					...
					<br><a href="db_store.php"><p>Comprar</a> | <a href="db_store_sell.php">Vender</p></a><br>
						...
						$html .= '<li class="selected" align="center"><a href="armas_de_fogo.php">Armas de Fogo</a></li>';
						...
						$sql = mysqli_query($con, "SELECT level_required,name,description,id,buy_value,slot FROM item WHERE type='1' ORDER BY level_required") or die(mysqli_error($con));
