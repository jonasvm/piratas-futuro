			...
			<div id="content">
				<div id="text">
					...
					<br><a href="db_store.php"><p>Comprar</a> | <a href="db_store_sell.php">Vender</p></a><br>
						...
						$html .= '<li class="selected" align="center"><a href="armaduras.php">Armaduras</a></li>';
						$html .= '<li align="center"><a href="consumiveis.php">Consumíveis</a></li>';
						$html .= '</ul>';
						...
						$sql = mysqli_query($con, "SELECT level_required,name,description,id,buy_value,slot FROM item WHERE type='3' ORDER BY level_required") or die(mysqli_error($con));
