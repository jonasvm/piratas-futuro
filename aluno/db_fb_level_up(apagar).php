		...
		<div id="main">
			...
			<div id="content">
				<div id="text">
						...
						$exp = $_GET["exp"]; //quantidade de experiencia recebida
						$user_id = $_SESSION["id"]; //id do usuário
						...
						if ( $current_lvl[1] >=  $last_lvl[1]) {
							...
							if( $new_xp <= $xp_max[0]){
								echo "<p>Você ganhou " . $exp . " de experencia!</p>";
						...
						?>
						<br>
						<p><a href="db_character.php">Clique aqui</a> para voltar para a página de seu personagem.</p>
					</div>
				</div>
		</div> 
	</body>
