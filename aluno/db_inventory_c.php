...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
		...
		<script>
			function sendData (user_id, item_id) {
				window.location = "db_use.php?user_id=" + user_id + "& item_id=" + item_id + "";
			}
		</script>
			...
			<div id="content">
				<div id="text">
					<p class="h2">Itens</p>
								...
								$html .= '<li align="center"><a href="db_inventory.php">Equipáveis</a></li>';
								$html .= '<li align="center" class="selected"><a href="consumiveis.php">Consumíveis</a></li>';
								$html .= '</ul>';
						...
						$html .= '<td align="center"><p class="title">Informações</p></td></tr>';
								...
								for ($i = 1; $i <= $num_rows; $i++) {
									...
									if($dados['upload'] == 0)                                    
										...
										$html .= '<br><input type="submit" value="Usar" onclick="sendData('.$_SESSION["id"].', '.$row[3].')" /></tr>';
									}
