			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">A miss&atilde;o n&atilde;o pode ser conclu&iacute;da  !</p><br>
							<p>Seu personagem n&atilde;o tem energia suficiente para realizar esta miss&atilde;o agora. Por favor, espere alguns minutos e tente novamente. </p>
						</form>
					</div>
				</div>
		</div> 
