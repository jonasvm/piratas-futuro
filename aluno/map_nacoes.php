...
$row = mysqli_fetch_row($sql);
if($row[6] != 3){
	mysqli_query($con, "UPDATE characterr SET location = '3' WHERE user_id = '$id'") or die(mysqli_error($con));
}
    ...
    <body>
		<div id="mainOverlay">
			...
			<div id="map">
				...
				<img src="images/Ilha das Nacoes.png" alt="" height="580" usemap="#Map" border="0" />
				
				<?php if( $row[5] >= 3 ) { ?>
					<a href="db_change_map.php?location_id=3.php"><img class="pin" src="images/pin.png" width="30" height="30" title="Mude sua localização para a Ilha das Nações"/></a>
				<?php } ?>
			</div>
		</div> 
	</body>
