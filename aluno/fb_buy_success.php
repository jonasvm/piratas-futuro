...
mysqli_query($con, "UPDATE activity_student SET sub_activity='Comprar', result='Sucesso.', data=curdate(), hour=curtime() WHERE id = '$row2'");
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
		...
		<link href="http://fonts.googleapis.com/css?family=Englebert" rel="stylesheet" type="text/css" /><link rel="stylesheet" type="text/css" href="style/style1024.css" media="only screen and (max-width:1245px)"/>
			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">Item comprado com sucesso!</p><br>
							<p>Seu item foi comprado com sucesso, <a href="db_inventory.php"><u>clique aqui</u></a> para seguir para seu inventário ou <a href="db_store.php"><u>continue comprando</u></a>.</p>
						</form>
					</div>
				</div>
		</div> 
