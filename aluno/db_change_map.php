		...
		<div id="main">
			...
			<div id="content">
				<div id="text">
					...
					$user_id = $_SESSION["id"];
					$sql = mysqli_query($con, "UPDATE characterr SET location = '$location_id' WHERE user_id = '$user_id'") or die(mysqli_error($con));
					echo '<p class="h2">Localização alterada com sucesso.</p>';
					echo "<p>Clique <a href='map.php'>aqui</a> para voltar ao mapa.</p>";
					mysqli_close($con);
					?>
				</div>
			</div>
