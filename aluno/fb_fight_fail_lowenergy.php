...
mysqli_query($con, "UPDATE activity_student SET sub_activity='Luta', result='Falha, energia insuficiente.', data=curdate(), hour=curtime() WHERE id = '$row2'");
?>
			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">Energia insuficiente !</p><br>
							<p>Seu personagem n&atilde;o tem energia suficiente para lutar agora. Por favor, tente novamente daqui alguns minutos.</p>
						</form>
					</div>
				</div>
		</div> 
