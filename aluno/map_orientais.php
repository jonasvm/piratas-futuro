...
$row = mysqli_fetch_row($sql);
if($row[6] != 2){
	mysqli_query($con, "UPDATE characterr SET location = '2' WHERE user_id = '$id'") or die(mysqli_error($con));
}
?>
    ...
    <body>
		<div id="mainOverlay">
			...
			<div id="map">
				...
				<img src="images/Ilha dos Orientais.png" alt="" height="580" usemap="#Map" border="0" />
				
				<?php if( $row[5] >= 2 ) { ?>
					<a href="db_change_map.php?location_id=2.php"><img class="pin" src="images/pin.png" width="30" height="30" title="Mude sua localização para a Ilha dos Orientais"/></a>
				<?php } ?>
			</div>
		</div> 
	</body>
