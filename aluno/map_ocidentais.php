...
$row = mysqli_fetch_row($sql);
if($row[6] != 1){
	mysqli_query($con, "UPDATE characterr SET location = '1' WHERE user_id = '$id'") or die(mysqli_error($con));
}
?>
    ...
    <body>
		<div id="mainOverlay">
			...
			<div id="map">
				...
				<img src="images/Ilha dos Ocidentais.png" alt="" height="580" usemap="#Map" border="0" />
				<a href="db_change_map.php?location_id=1.php"><img class="pin" src="images/pin.png" width="30" height="30" title="Mude sua localização para a Ilha dos Ocidentais"/></a>
			</div>
		</div> 
	</body>
</html>
