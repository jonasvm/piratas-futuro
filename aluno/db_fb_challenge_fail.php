...
//Dados do Desafio
$sql = mysqli_query($con, "SELECT * FROM challenge WHERE id = '$challenge_id'") or die(mysqli_error($con));
$row = mysqli_fetch_row($sql);
...
mysqli_query($con, "UPDATE activity_student SET sub_activity='$row[1]', result='Falha, erro encontrado.', data=curdate(), hour=curtime() WHERE id = '$row3'");
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
		<div id="main">
			...
			<div id="content">
				<div id="text">
						<br><p class="h2" style="text-align:center;color:#FF0000;">ERRADO! Parece que o mar está muito agitado para você marujo, vai pular da prancha ou tentar de novo?</p class="h2"></br>
						<br><img src="images/caveira.png" style="display:block; margin:auto;"/></br>
						<br><input type="button" value="Voltar para o desafio" style="display:block; margin:auto;" onClick="history.go(-1)">			
