...
mysqli_query($con, "UPDATE activity_student SET sub_activity='Luta', result='Falha, vida insuficiente.', data=curdate(), hour=curtime() WHERE id = '$row2'");
?>
			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">Seus pontos de vida est&atilde;o muito baixos !</p><br>
							<p>Seu personagem n&atilde;o tem pontos de vida suficiente para lutar agora. Por favor, tente novamente daqui alguns minutos.</p>
						</form>
					</div>
				</div>
		</div> 
