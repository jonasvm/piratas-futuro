...
$row = mysqli_fetch_row($sql);
if($row[6] != 4){
	mysqli_query($con, "UPDATE characterr SET location = '4' WHERE user_id = '$id'") or die(mysqli_error($con));
}
?>
    ...
    <body>
		<div id="mainOverlay">
			...
			<div id="map">
				...
				<img src="images/Nova Africa.png" alt="" height="580" usemap="#Map" border="0" />
				<?php if( $row[5] >= 4 ) { ?>
					<a href="db_change_map.php?location_id=4.php"><img class="pin" src="images/pin.png" width="30" height="30" title="Mude sua localização para a Nova África"/></a>
				<?php } ?>
			</div>
		</div> 
	</body>
