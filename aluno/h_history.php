		...
		<div id="main">
			...
			<div id="content">
				<div id="text">
					...
					<p>Como os governos não conseguem mais garantir um nível de vida para os cidadãos, todos renegaram seus políticos no começo, e em algum ponto da história a
					política convencional morreu e ressurgiram os governos militares.</p>
					<p>Você jogador, não é aliado de nenhum destes governos. Você leva uma vida errante e tira proveito das melhores situações, seja de um governo ou de outro.</p>
					<p>Os chefes das nações oferecem com certa frequência missões em um sistema de divulgação, e é daí que provém seu sustento. Se por ventura as missões ficarem
					muito difíceis ou escassas, você pode aumentar sua renda nas arenas, que também é uma ótima fonte de renome!</p>
					<p>Porém, se você é daqueles que gosta das tarefas mais difíceis, existe uma lista com ótimos desafios à serem superados. Os desafios são a melhor forma de
					evoluir seu personagem e melhorar seu ranking, mas, como contrapartida existe o pequeno problema a ser resolvido...</p>
					<p>Não se esqueça de gerenciar seus equipamentos e suas habilidades, são eles que fazem o diferencial em seu personagem!</p>
					<p>Para finalizar, quando passar de nível, não se esqueça de atualizar seu personagem!</p>
                    <br>
					</div>
				</div>
		</div> 
