...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
		<div id="main">
			...
			<div id="content">
				<div id="text">
					<p class="h2">A vida n&atilde;o &eacute; f&aacute;cil no mundo pirata!</p>
                    ...
                    <p> Boa sorte no mundo pirata!</p><br>
                    <p><a href="db_managing_character.php">Seguir para o jogo <img width="10px" height="10px" src="images/marcador.png"/> </a></p><br>
					</div>
				</div>
		</div> 
	</body>
