...
mysqli_query($con, "UPDATE activity_student SET sub_activity='Desequipar', result='Sucesso.', data=curdate(), hour=curtime() WHERE id = '$row3'");
?>
			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">Item desequipado com sucesso!</p><br>
							<p>Seu item foi desequipado com sucesso, <a href="db_inventory.php">clique aqui</a> para voltar para seu inventário.</p>
						</form>
					</div>
				</div>
		</div> 
