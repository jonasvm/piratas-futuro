...
mysqli_query($con, "UPDATE activity_student SET sub_activity='Comprar', result='Falha, dinheiro insuficiente.', data=curdate(), hour=curtime() WHERE id = '$row2'");
?>
			...
			<div id="content">
				<div id="text">
						<form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="">
							<p class="h2">N&atilde;o foi poss&iacute;vel comprar o item !</p><br>
							<p>Talvez voc&ecirc; n&atilde;o tenha dinheiro suficiente para adquirir o item agora, fa&ccedil;a mais algumas miss&otilde;es e volte mais tarde!</p>
							<p><a href="db_inventory.php">Clique aqui</a> para seguir para seu inventário.</p>
						</form>
					</div>
				</div><div id="right_content"></div>
			</div>
		</div> 
	</body>
</html>
